...
class CommentResource(ModelResource):
    ...
    post = fields.ForeignKey('source.post.apis.PostResource', 'post', full=True)
    class Meta:
...
class PostResource(ModelResource):
    author = fields.ForeignKey(UserResource, 'author', full=True)
    list_comment = fields.ToManyField(CommentResource, 'post_commented', null=True)
    ...
    def like_post(self, request, **kwargs):
        ...
        if user_id is None:
            raise CustomBadRequest(error_type='UNAUTHORIZED', error_message='Please signin first')
